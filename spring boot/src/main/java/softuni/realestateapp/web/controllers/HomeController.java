...
import softuni.realestateapp.domain.models.view.OfferViewModel;
...
public class HomeController {
    ...
    private String prepareHtml() throws IOException {
        List<OfferViewModel> offers = this.offerService.findAllOffers()
                .stream()
                .map(o ->
                        this.modelMapper.map(o, OfferViewModel.class))
        ...
        if (offers.size() == 0) {
            ...
            for (OfferViewModel offer : offers) {
                offersHtml
                        ...
                        .append(String.format("<p>Rent: %.2f</p>",
                                offer.getApartmentRent()))
                        .append(String.format("<p>Type: %s</p>",
                                offer.getApartmentType()))
                        .append(String.format("<p>Commission: %.2f</p>",
        ...
        return this.htmlReader
                .readHtmlFile("src/main/resources/static/index.html")
